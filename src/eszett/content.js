...
function processNodeIfRelevant(node) {
  ...
  if (el.querySelectorAll) {
    el.querySelectorAll("input, textarea, [contenteditable=''], [contenteditable='true']").forEach(processEditable);
  }
}

// Initial pass
walkAndProcess(document.body);
document.querySelectorAll("input, textarea, [contenteditable=''], [contenteditable='true']").forEach(processEditable);
